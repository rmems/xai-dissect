...
//
//! Inventory Markdown/JSON writers (`inventory.md`, snapshot and coverage manifests).
...
use crate::schema::{
    BlockSummary, CheckpointInventorySnapshot, FindingsSummary, Grok1CoverageManifest,
    ModelInventory,
};
